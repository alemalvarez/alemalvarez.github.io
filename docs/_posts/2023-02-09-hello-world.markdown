...
{% highlight shell %}
# It originally said "ls -A", but exa wasn´t recognising the option.
...
I will try to be somewhat consistent in posting and keep everything cathegorized and tidy, but who knows.
